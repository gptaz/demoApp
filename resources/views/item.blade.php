...
<!-- banner -->
    ...
    <section class="slider">
      ...
      <div class="agileinfo_single">
				<h5>Sunrise rice medium 5 kg</h5>
				...
				<div class="col-md-8 agileinfo_single_right">
					...
					<div class="w3agile_description">
						<h4>Description :</h4>
						<p>A culinary delight that elevates any meal. Grown in the fertile regions, 
              our rice boasts a fragrant aroma and exquisite taste. Each grain cooks to perfection, delivering a light, 
              fluffy texture. Elevate your dining experience with the finest quality rice, perfect for diverse culinary creations.</p>
					</div>
								...
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('item')}}"><img src="images/5.png" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('item')}}"><img src="images/6.png" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('item')}}"><img src="images/7.png" alt=" " class="img-responsive" /></a>
						...
						<div class="agile_top_brand_left_grid w3l_agile_top_brand_left_grid">
							...
							<div class="agile_top_brand_left_grid1">
								<figure>
									<div class="snipcart-item block">
										<div class="snipcart-thumb">
											<a href="{{route('item')}}"><img src="images/8.png" alt=" " class="img-responsive" /></a>
